...
export default function App() {
  ...
  useEffect(() => {
    const titles: Record<string, string> = {
      ...
      update: 'Changelog', trusted: 'Trusted List', clowns: 'Certified Clowns',
      yakktrader: 'YAKK AI Trader', predictions: 'Prediction Markets',
      cabal: 'Cabal Investigator', nftmarket: 'NFT Market', launchpad: 'YAKK Ventures',
      ...
      bridge: 'Bridge Swap', terms: 'Terms of Service', privacypolicy: 'Privacy Policy',
    };
    ...
    <div id="app">
      ...
      <div id="main-wrap">
        ...
        <div id="main">
          ...
          <div className={`page-section ${section === 'update'       ? 'active' : ''}`}><ErrorBoundary sectionName="Changelog">    <Update       {...sectionProps} /></ErrorBoundary></div>
          ...
          <div className={`page-section ${section === 'news'         ? 'active' : ''}`}><ErrorBoundary sectionName="News">         <News /></ErrorBoundary></div>
