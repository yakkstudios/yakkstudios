    ...
    <div className="sec-pad">
      <div className="sec-header">
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 6 }}>
          <div className="sec-title">ð CABAL INVESTIGATOR</div>
        </div>
        <div className="sec-sub">On-chain wallet analysis. Track influencers, whales & insider wallets.</div>
        {/* YST gate badge */}
      ...
      {walletConnected && ystBalance < 250_000 && (
        <div className="locked-overlay">
          ...
          <div className="locked-sub">
            You need <strong>250,000+ $YST</strong> staked to access CABAL INVESTIGATOR.
        ...
        <div className="section-placeholder">
          <div className="section-wip">
            ...
            <div className="section-wip-text">
              <strong>CABAL INVESTIGATOR</strong> â This section is being migrated to the new React architecture.
