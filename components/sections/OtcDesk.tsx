  ...
  return (
    <div className="sec-pad">
      <div className="sec-header">
        ...
        <div className="sec-sub">Peer-to-peer token swaps. No slippage. Private & trustless.</div>
        {/* YST gate badge */}
      ...
      {!walletConnected && (
        <div className="locked-overlay">
          ...
          <div className="locked-title">OTC DESK</div>
      ...
      {walletConnected && ystBalance < 250_000 && (
        <div className="locked-overlay">
          ...
          <div className="locked-sub">
            You need <strong>250,000+ $YST</strong> staked to access OTC DESK.
        ...
        <div className="section-placeholder">
          <div className="section-wip">
            ...
            <div className="section-wip-text">
              <strong>OTC DESK</strong> â This section is being migrated to the new React architecture.
