  ...
  return (
    <div className="sec-pad">
      ...
      <div style={{ background: 'rgba(247,201,72,0.06)', border: '1px solid rgba(247,201,72,0.2)', borderRadius: 12, padding: '20px 24px', marginBottom: 24, display: 'flex', alignItems: 'center', gap: 20, flexWrap: 'wrap' }}>
        <div style={{ flex: 1 }}>
          <div style={{ fontFamily: 'Syne,sans-serif', fontWeight: 800, fontSize: 16, marginBottom: 6 }}>ð Stake $YST. Earn Rewards.</div>
          <div style={{ fontSize: 12, color: 'var(--muted)', lineHeight: 1.6, marginBottom: 12 }}>
            StakePoint is YAKK Studios' official staking partner. Stake your $YST to:<br />
            â¢ Earn platform revenue share in SOL<br />
            â¢ Unlock all YAKK Studios tools<br />
            â¢ Access exclusive holder-only features<br />
            â¢ Participate in governance votes
          </div>
          <a href="https://stakepoint.app" target="_blank" rel="noopener noreferrer" className="btn btn-gold">Launch StakePoint App â</a>
        </div>
      ...
      <div className="grid3" style={{ marginBottom: 24 }}>
        {[
          { emoji: 'ð', title: 'MINIMUM HOLD', desc: 'No minimum â any amount of $YST unlocks basic features. 250K+ for full access.' },
          { emoji: 'ð¸', title: 'REV-SHARE', desc: 'Platform fees distributed to stakers weekly in SOL. Higher hold = bigger share.' },
          { emoji: 'ð³ï¸', title: 'GOVERNANCE', desc: 'Vote on platform direction, new features & fee structures. Your YST = your vote.' },
        ].map(c => (
      ...
      <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
        <a href="https://stakepoint.app" target="_blank" rel="noopener noreferrer" className="btn btn-gold">Open StakePoint â</a>
