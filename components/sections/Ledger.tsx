    ...
    <div className="sec-pad">
      <div className="sec-header">
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 6 }}>
          <div className="sec-title">ð RUG LEDGER</div>
        </div>
        <div className="sec-sub">Community-maintained ledger of rugs, scams & bad actors.</div>
        {/* YST gate badge */}
      ...
      {walletConnected && ystBalance < 250_000 && (
        <div className="locked-overlay">
          ...
          <div className="locked-sub">
            You need <strong>250,000+ $YST</strong> staked to access RUG LEDGER.
        ...
        <div className="section-placeholder">
          <div className="section-wip">
            ...
            <div className="section-wip-text">
              <strong>RUG LEDGER</strong> â This section is being migrated to the new React architecture.
