...
const FEATURES = [
  { icon: 'ð', title: 'Price Alerts', desc: 'Set custom price alerts for any Solana token. Get instant Telegram pings.', status: 'LIVE', badge: 'b-green' },
  { icon: 'ð', title: 'Portfolio Tracking', desc: 'Track your Solana wallet P&L directly from Telegram.', status: 'LIVE', badge: 'b-green' },
  { icon: 'âï¸', title: 'Raid Notifications', desc: 'Get notified when a new YAKK raid goes live. Never miss community events.', status: 'LIVE', badge: 'b-green' },
  { icon: 'ð', title: 'Whale Alerts', desc: 'Monitor big wallet moves on Solana in real-time.', status: 'BETA', badge: 'b-yakk' },
  { icon: 'ð¤', title: 'AI Q&A', desc: 'Ask the bot anything about YAKK, Solana DeFi or your portfolio.', status: 'SOON', badge: 'b-dim' },
];
    ...
    <div className="sec-pad">
      <div className="sec-header">
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 6 }}>
          <div className="sec-title">ð¤ TELEGRAM BOT</div>
          <span className="badge b-blue">LIVE</span>
        </div>
        <div className="sec-sub">The official YAKK Studios Telegram bot â price alerts, portfolio tracking, raids &amp; more.</div>
      </div>
      ...
      <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
        <a href="https://t.me/YAKKStudiosBot" target="_blank" rel="noopener noreferrer" className="btn btn-blue">@YAKKStudiosBot â</a>
        <a href="https://t.me/yakkstudios" target="_blank" rel="noopener noreferrer" className="btn btn-outline">YAKK Community Chat â</a>
        <a href="https://t.me/yakkannouncements" target="_blank" rel="noopener noreferrer" className="btn btn-outline">Announcements Channel â</a>
      </div>
    </div>
  );
}
