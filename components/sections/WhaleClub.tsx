  ...
  return (
    <div className="sec-pad">
      <div className="sec-header">
        ...
        <div className="sec-sub">The exclusive club for 10M+ $YST stakers. Whales only.</div>
        {/* Whale gate badge */}
        <div className="gate-badge">
          <span className="gate-badge-text"><span>10,000,000+ $YST</span> Staked on StakePoint</span>
          <span className="badge b-dim">WHALE ONLY</span>
        </div>
      </div>
      ...
      {!walletConnected && (
        <div className="locked-overlay">
          ...
          <div className="locked-sub">
            ...
            <strong>10,000,000+ $YST</strong> on StakePoint to access this tool.
          </div>
      ...
      {walletConnected && ystBalance < 10_000_000 && (
        <div className="locked-overlay">
          <div className="locked-icon">ð</div>
          <div className="locked-title">Insufficient Stake</div>
          <div className="locked-sub">
            You need <strong>10,000,000+ $YST</strong> staked to access WHALE CLUB.
        ...
        <div className="section-placeholder">
          <div className="section-wip">
            ...
            <div className="section-wip-text">
              <strong>WHALE CLUB</strong> â This section is being migrated to the new React architecture.
