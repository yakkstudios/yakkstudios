    ...
    <div className="sec-pad">
      ...
      {walletConnected && ystBalance < 250_000 && (
        <div className="locked-overlay">
          ...
          <div className="locked-sub">
            You need <strong>250,000+ $YST</strong> staked to access YAKK SCREENER.
        ...
        <div className="section-placeholder">
          <div className="section-wip">
            ...
            <div className="section-wip-text">
              <strong>YAKK SCREENER</strong> â This section is being migrated to the new React architecture.
