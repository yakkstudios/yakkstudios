...
const UPDATES = [
  {
    version: 'v2.4.0', date: 'March 2025', type: 'MAJOR', badge: 'b-pink',
  ...
  {
    version: 'v2.3.1', date: 'February 2025', type: 'FIX', badge: 'b-gold',
  ...
  {
    version: 'v2.3.0', date: 'January 2025', type: 'FEATURE', badge: 'b-green',
  ...
  {
    version: 'v2.2.0', date: 'December 2024', type: 'FEATURE', badge: 'b-green',
  ...
  {
    version: 'v2.1.0', date: 'November 2024', type: 'FEATURE', badge: 'b-blue',
...
export default function Update({ walletConnected, ystBalance, onNavigate }: Props) {
  ...
  // ── Hard gate — nothing renders below if no access ────────────────────────
  if (!hasAccess) {
    return (
      <div className="sec-pad">
        <div className="locked-overlay">
          ...
          <div className="locked-sub">
            Connect your wallet and hold <strong>10,000,000 $YST</strong> to unlock this section.
          </div>
  ...
  return (
    <div className="sec-pad">
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 6 }}>
        <div className="sec-title">📋 CHANGELOG</div>
        <span className="badge b-green">PLATFORM UPDATES</span>
      </div>
      ...
      <div className="grid4" style={{ marginBottom: 24 }}>
        {[
          ...
          { l: 'SECTIONS LIVE',   v: '32',     c: 'var(--green)' },
          { l: 'LAST UPDATED',    v: 'Apr 2026', c: 'var(--text)' },
        ].map(s => (
      ...
      <div style={{ background: 'rgba(236,72,153,0.04)', border: '1px solid rgba(236,72,153,0.15)', borderRadius: 10, padding: '16px 20px' }}>
        ...
        <div style={{ fontSize: 11, color: 'var(--muted)', lineHeight: 1.7 }}>
          Mobile app (iOS + Android), AI-powered rug pull detector, Telegram notifications, cross-chain support, Discord holder verification, and on-chain copy trading — all driven by community votes.
        </div>
