  ...
  return (
    <div className="sec-pad">
      <div className="sec-header">
        ...
        <div className="sec-sub">Exclusive member directory. Connect with fellow $YST holders.</div>
        {/* YST gate badge */}
      ...
      {!walletConnected && (
        <div className="locked-overlay">
          ...
          <div className="locked-title">MEMBERS</div>
      ...
      {walletConnected && ystBalance < 250_000 && (
        <div className="locked-overlay">
          ...
          <div className="locked-sub">
            You need <strong>250,000+ $YST</strong> staked to access MEMBERS.
        ...
        <div className="section-placeholder">
          <div className="section-wip">
            ...
            <div className="section-wip-text">
              <strong>MEMBERS</strong> â This section is being migrated to the new React architecture.
